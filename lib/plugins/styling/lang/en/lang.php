...
$lang['screen'] = 'Edit <code>conf/userstyle</code> for style to be applaied in screen mode';
$lang['print'] = 'Edit <code>conf/userprint</code> for style to be applaied when a page is printed';
$lang['feed'] = 'Edit <code>conf/userfeed</code> for style to be applaied when displaying the feed';
$lang['all'] = 'Edit <code>conf/userall</code> for style to be applaied in all display modes';
